        ...
        <div className="UseReducer">
            ...
            <div className="center">
                ...
                <div>
                    ...
                    <button className="btn"
                        onClick={() => dispatch({type: 'numberInt'})}>Int number</button>
                    <button className="btn"
                        onClick={() => dispatch({type: 'numberAddN', payload: -9})}>Add (-9)</button>
                    <button className="btn"
                        onClick={() => dispatch({type: 'numberAddN', payload: + 11})}>Add (+11)</button>
                </div>
            </div>
        </div>
    )
